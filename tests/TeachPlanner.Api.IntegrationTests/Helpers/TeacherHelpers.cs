...
internal static class TeacherHelpers
{
    ...
    internal static Teacher CreateTeacher(string userId, int year)
    {
        var teacher = Teacher.Create(userId, "First", "Last");
        teacher.CompleteAccountSetup(year, TestConstants.FirstDayOfTerm2024);
    ...
    {
        return new AccountSetupRequest(TestConstants.SubjectNames, CreateYearLevelsTaughtAsStringList(),
