...
public class TeacherRepository : ITeacherRepository
{
    ...
    public async Task<Teacher?> GetByIdWithResources(TeacherId teacherId, IEnumerable<ResourceId> resources,
    ...
    public async Task<YearData?> GetYearDataByYear(TeacherId teacherId, int calendarYear,
        CancellationToken cancellationToken)
    {
