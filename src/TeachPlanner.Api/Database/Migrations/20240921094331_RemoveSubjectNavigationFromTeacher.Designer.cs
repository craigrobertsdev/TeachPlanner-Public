...
namespace TeachPlanner.Api.Database.Migrations
{
    ...
    [Migration("20240921094331_RemoveSubjectNavigationFromTeacher")]
    partial class RemoveSubjectNavigationFromTeacher
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.Curriculum.CurriculumSubject", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.Curriculum.YearLevel", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.PlannerTemplates.WeekStructure", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.Users.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.WeekPlanners.DayPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("TeachPlanner.Shared.ValueObjects.Location", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Shared.ValueObjects.SchoolEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("char(36)")
                        .HasColumnName("Id");
            ...
            modelBuilder.Entity("TeachPlanner.Shared.ValueObjects.TermDate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("CalendarSchoolEvent", b =>
                {
                    ...
                    b.HasOne("TeachPlanner.Shared.ValueObjects.SchoolEvent", null)
                        .WithMany()
            ...
            modelBuilder.Entity("CurriculumSubjectTermPlan", b =>
                {
                    b.HasOne("TeachPlanner.Api.Domain.Curriculum.CurriculumSubject", null)
                        .WithMany()
            ...
            modelBuilder.Entity("DayPlanSchoolEvent", b =>
                {
                    b.HasOne("TeachPlanner.Api.Domain.WeekPlanners.DayPlan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("TeachPlanner.Api.Domain.Users.ApplicationUser", null)
                        .WithMany()
                    ...
                    b.OwnsOne("TeachPlanner.Api.Domain.Assessments.AssessmentResult", "AssessmentResult", b1 =>
                        {
                            ...
                            b1.OwnsOne("TeachPlanner.Shared.ValueObjects.AssessmentGrade", "Grade", b2 =>
                                {
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.Curriculum.YearLevel", b =>
                {
                    ...
                    b.OwnsMany("TeachPlanner.Api.Domain.Curriculum.Capability", "Capabilities", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");
                    ...
                    b.OwnsMany("TeachPlanner.Api.Domain.Curriculum.ConceptualOrganiser", "ConceptualOrganisers", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");
                            ...
                            b1.OwnsMany("TeachPlanner.Api.Domain.Curriculum.ContentDescription", "ContentDescriptions", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("char(36)");
                    ...
                    b.OwnsMany("TeachPlanner.Api.Domain.Curriculum.Disposition", "Dispositions", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("TeachPlanner.Api.Domain.PlannerTemplates.WeekStructure", b =>
                {
                    ...
                    b.HasOne("TeachPlanner.Api.Domain.YearDataRecords.YearData", null)
                        ...
                        .HasForeignKey("TeachPlanner.Api.Domain.PlannerTemplates.WeekStructure", "YearDataId");

                    b.OwnsMany("TeachPlanner.Api.Domain.PlannerTemplates.DayTemplate", "DayTemplates", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");

                            b1.Property<bool>("IsNonWorkingDay")
                                .HasColumnType("tinyint(1)");
                            ...
                            b1.OwnsMany("TeachPlanner.Api.Domain.PlannerTemplates.LessonTemplate", "Lessons", b2 =>
                                {
                                    b2.Property<Guid>("Id")
                                        .ValueGeneratedOnAdd()
                                        .HasColumnType("char(36)");
                    ...
                    b.OwnsMany("TeachPlanner.Shared.ValueObjects.TemplatePeriod", "Periods", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("char(36)");
                    ...
                    b.OwnsMany("TeachPlanner.Api.Domain.YearDataRecords.Subject", "Subjects", b1 =>
                        {
                            ...
                            b1.HasOne("TeachPlanner.Api.Domain.Curriculum.CurriculumSubject", null)
                                .WithMany()
                                .HasForeignKey("CurriculumSubjectId")
                                .OnDelete(DeleteBehavior.NoAction)
                                .IsRequired();
            ...
            modelBuilder.Entity("TeachPlanner.Shared.ValueObjects.SchoolEvent", b =>
                {
                    b.HasOne("TeachPlanner.Shared.ValueObjects.Location", "Location")
                        .WithMany()
