...
public static class UpdateWeekStructure
{
    ...
    public static async Task<IResult> Delegate(Guid teacherId, WeekStructureRequest request, int calendarYear, ISender sender, CancellationToken cancellationToken)
    {
