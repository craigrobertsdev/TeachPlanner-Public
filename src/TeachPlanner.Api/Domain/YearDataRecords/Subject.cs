...
{
    private readonly List<YearDataContentDescription> _contentDescriptions = [];
    ...
    public static Subject Create(SubjectId curriculumSubjectId, string name,
        List<YearDataContentDescription> contentDescriptions)
    {
